...
---@field public MaxItemsOnScreen fun(self: table, max: number|nil):number -- Maximum number of items that can be displayed (default: 7)
---@field public AddItem fun(self: table, item: UIMenuItem)
---@field public SetParentMenu fun(self: table, menu: UIMenu)
---@field public OnIndexChange fun(self: table, menu: UIMenu, newindex: number)
---@field public OnListChange fun(self: table, menu: UIMenu, list: UIMenuListItem, newindex: number)
---@field public OnSliderChange fun(self: table, menu: UIMenu, slider: UIMenuSliderItem, newindex: number)
---@field public OnProgressChange fun(self: table, menu: UIMenu, progress: UIMenuProgressItem, newindex: number)
---@field public OnCheckboxChange fun(self: table, menu: UIMenu, checkbox: UIMenuCheckboxItem, checked: boolean)
---@field public OnListSelect fun(self: table, menu: UIMenu, item: UIMenuItem, index: number)
---@field public OnSliderSelect fun(self: table, menu: UIMenu, item: UIMenuItem, index: number)
---@field public OnStatsSelect fun(self: table, menu: UIMenu, item: UIMenuItem, index: number)
---@field public OnItemSelect fun(self: table, menu: UIMenu, item: UIMenuItem, checked: boolean)
---@field public OnMenuChanged fun(self: table, oldmenu: UIMenu, newmenu: UIMenu, change: any)
---@field public BuildAsync fun(self: table, enabled: boolean|nil):boolean -- If the menu should be built async (default: false)
---@field public AnimationEnabled fun(self: table, enabled: boolean|nil):boolean -- If the menu animation is enabled or disabled (default: true)
---@field public AnimationType fun(self: table, type: MenuAnimationType|nil):MenuAnimationType -- Animation type for the menu (default: MenuAnimationType.LINEAR)
---@field public BuildingAnimation fun(self: table, type: MenuBuildingAnimation|nil):MenuBuildingAnimation -- Build animation type for the menu (default: MenuBuildingAnimation.LEFT)
---@field public BindMenuToItem fun(self: table, menu: UIMenu, item: UIMenuItem) -- Binds a menu to an item
---@field public Visible fun(self: table, visible: boolean|nil):boolean -- If the menu is visible or not (default: false)
