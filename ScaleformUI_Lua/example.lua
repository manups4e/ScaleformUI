...
function CreateMenu()
	...
	local detailItem1 = UIMenuFreemodeDetailsItem.New("Left Label", "Right Label", BadgeStyle.BRIEFCASE, Colours.HUD_COLOUR_FREEMODE)
	local detailItem2 = UIMenuFreemodeDetailsItem.New("Left Label", "Right Label", BadgeStyle.STAR, Colours.HUD_COLOUR_GOLD)
	local detailItem3 = UIMenuFreemodeDetailsItem.New("Left Label", "Right Label", BadgeStyle.ARMOR, Colours.HUD_COLOUR_PURPLE)
	local detailItem4 = UIMenuFreemodeDetailsItem.New("Left Label", "Right Label", BadgeStyle.BRAND_DILETTANTE, Colours.HUD_COLOUR_GREEN)
	local detailItem5 = UIMenuFreemodeDetailsItem.New("Left Label", "Right Label", BadgeStyle.COUNTRY_GERMANY, Colours.HUD_COLOUR_WHITE, true)
