...
namespace ScaleformUI
{
    public abstract class TimerBarBase
    {
        ...
        public virtual void Draw(int interval)
        {
            ...
            new Sprite("timerbars", "all_black_bg", new PointF((int)res.Width - safe.X - 298, (int)res.Height - safe.Y - (40 + (4 * interval))), new SizeF(300, 37), 0f, new Color(180, 255, 255, 255)).Draw();
